      ...
      <AuthProvider>
        ...
        <Routes>
          ...
          <Route element={<RoleMiddleware allowedRoles={['ADMIN', 'SUPERADMIN']} />}>
            ...
            <Route path="/admin/courses/:courseId/analytics" element={<CourseAnalyticsScreen />} />
            <Route path="/admin/users" element={<ManageUsersScreen />} />
            <Route path="/admin/users/new" element={<UserEditorScreen />} />
            <Route path="/admin/users/:userId/analytics" element={<UserAnalyticsScreen />} />
            <Route path="/admin/assign/:userId" element={<AssignCoursesScreen />} />
            <Route path="/admin/courses/:courseId/assign" element={<AssignUsersToCourseScreen />} />
          </Route>
          <Route
            path="*"
            element={
