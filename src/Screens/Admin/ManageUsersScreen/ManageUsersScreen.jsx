        ...
        <div className="screen-container">
            <div className="admin-panel-container">
                <div className="admin-panel-header" style={{ alignItems: 'center' }}>
                    ...
                    <Link to="/admin/users/new" className="btn-primary" style={{ flexShrink: 0 }}>
                                    ...
                                    <tr key={user._id} className={!user.activo ? "mu-row-inactive" : ""}>
                                        ...
                                        <td>
                                            <div className="table-actions">
                                                <Link to={`/admin/users/${user._id}/analytics`} className="btn-icon" title="Ver Analíticas" style={{ color: 'var(--accent-color)' }}>
                                                    <BarChart2 size={18} />
